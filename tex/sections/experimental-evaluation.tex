...
\begin{figure}
	...
	\includegraphics[height=.21\textwidth]{best-views-estimation/active-perception/1-sensor/rviz-back-corner}\hspace{2em}
	\includegraphics[height=.21\textwidth]{best-views-estimation/active-perception/1-sensor/rviz-top}
...
\begin{figure}
	...
	\includegraphics[height=.24\textwidth]{best-views-estimation/active-perception/3-sensors/rviz-back-left}%\hspace{1em}
	\includegraphics[height=.24\textwidth]{best-views-estimation/active-perception/3-sensors/rviz-top}
...
%	\includegraphics[height=.14\textwidth]{best-views-estimation/bin-picking/1-sensor/rviz-front}\\
	\includegraphics[height=.25\textwidth]{best-views-estimation/bin-picking/1-sensor/rviz-top-front}%\hspace{0.5em}
	\includegraphics[height=.25\textwidth]{best-views-estimation/bin-picking/1-sensor/rviz-top}
...
%	\includegraphics[height=.19\textwidth]{best-views-estimation/bin-picking/5-sensors/gazebo-front}\hspace{2em}
	\includegraphics[height=.19\textwidth]{best-views-estimation/bin-picking/5-sensors/rviz-top}%\hspace{1em}
	\includegraphics[height=.24\textwidth]{best-views-estimation/bin-picking/5-sensors/rviz-corner}%\hspace{2em}
...
%	\includegraphics[height=.13\textwidth]{best-views-estimation/bin-picking-with-occlusions/1-sensor/gazebo-top}\hspace{2em}
	\includegraphics[height=.18\textwidth]{best-views-estimation/bin-picking-with-occlusions/1-sensor/rviz-corner}
%	\includegraphics[height=.2\textwidth]{best-views-estimation/bin-picking-with-occlusions/1-sensor/rviz-front}\hspace{2em}
	\includegraphics[height=.24\textwidth]{best-views-estimation/bin-picking-with-occlusions/1-sensor/rviz-top}
...
%	\includegraphics[height=.18\textwidth]{best-views-estimation/bin-picking-with-occlusions/3-sensors/gazebo-top}\hspace{2em}
	\includegraphics[height=.23\textwidth]{best-views-estimation/bin-picking-with-occlusions/3-sensors/rviz-front}%\hspace{1em}
	\includegraphics[height=.23\textwidth]{best-views-estimation/bin-picking-with-occlusions/3-sensors/rviz-top-back}%\hspace{2em}
%	\includegraphics[height=.2\textwidth]{best-views-estimation/bin-picking-with-occlusions/3-sensors/rviz-top}
...
\begin{figure}
	\centering
%	\includegraphics[width=.24\textwidth]{best-views-estimation/multiple-bin-picking-with-occlusions/10-sensors/gazebo-front}\vspace{2em}
	\includegraphics[width=.22\textwidth]{best-views-estimation/multiple-bin-picking-with-occlusions/10-sensors/rviz-front-corner}%\vspace{2em}
%	\includegraphics[width=.24\textwidth]{best-views-estimation/multiple-bin-picking-with-occlusions/10-sensors/rviz-front}\vspace{2em}
	\includegraphics[width=.26\textwidth]{best-views-estimation/multiple-bin-picking-with-occlusions/10-sensors/rviz-top}
